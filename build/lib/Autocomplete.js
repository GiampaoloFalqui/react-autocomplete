...
var Autocomplete = function (_React$Component) {
  ...
  _createClass(Autocomplete, [{
    ...
    key: 'handleKeyboardSelection',
    value: function handleKeyboardSelection(event) {
      var _this3 = this;
      ...
      if (!this.isOpen()) {
        ...
        this.setState({
          ...
          _this3.refs.input.setSelectionRange(value.length, value.length);
    ...
    value: function renderMenu() {
      ...
      var items = this.getFilteredItems(this.props).map(function (item, index) {
        ...
        return React.cloneElement(element, {
          onMouseEnter: _this5.props.isItemSelectable(item) ? function () {
            return _this5.highlightItemFromMouse(index);
          } : null,
          onClick: _this5.props.isItemSelectable(item) ? function () {
    ...
    value: function handleInputBlur(event) {
      ...
      if (this.props.selectOnBlur && highlightedIndex !== null) {
        ...
        setStateCallback = function setStateCallback() {
          return _this6.props.onSelect(value, item);
        };
      }
      this.setState({
        isOpen: false,
