...
class Autocomplete extends React.Component {
  ...
  handleKeyboardSelection(event) {
    ...
    if (!this.isOpen()) {
      ...
      // input has focus but no menu item is selected + tab is hit -> close the menu, highlight whatever's in input
      this.setState({
        isOpen: false
      }, () => {
      ...
      // text entered + menu item has been highlighted + tab is hit -> update value to that of selected menu item, close the menu
      if (key === 'Enter') {
